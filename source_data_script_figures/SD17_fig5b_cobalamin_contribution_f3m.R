...
# This script generates the histogram representing bacterial species contribution to cobalamin biosynthesis genes in cereals flours (n=19) and related couscous (n=19)
...
ggsave(
  filename = "plots/SD17_fig5b_cobalamin_contribution_f3m.png", 
  plot = p_no_legend,              
  width = 100,                      
  height = 70,
  units = "mm",
...
ggsave(
  filename = "plots/SD17_fig5b_cobalamin_contribution_f3m_legend.png",  
  plot = legend,              
  width = 30,                      
  height = 100,
  units = "mm",                    
...
# Export SVG
ggsave(
  filename = "plots/SD17_fig5b_cobalamin_contribution_f3m.svg", 
  plot = p_no_legend,              
  width = 100,                      
  height = 70,
  units = "mm",
...
ggsave(
  filename = "plots/SD17_fig5b_cobalamin_contribution_f3m_legend.svg",  
  plot = legend,              
  width = 30,                      
  height = 100,
  units = "mm",                    
...
# To export table
write_xlsx(f3m_table_matrix_pct, "SD17_fig5b_cobalamin_contribution_f3m.xlsx")
